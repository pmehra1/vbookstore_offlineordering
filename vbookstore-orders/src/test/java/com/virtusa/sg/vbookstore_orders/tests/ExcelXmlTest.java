...
public class ExcelXmlTest extends CamelTestSupport {

	private static Logger log = LoggerFactory.getLogger(ExcelXmlTest.class);
	...
	public void testXmlToCannonicalXml() throws Exception {
		String inputFile = Constants.getBasePathForDataFiles() + "excelxml\\vbookstore_order.xlsx";
		String outputFile = Constants.getBasePathForDataFiles() + "excelxml\\cannonical.xml";
	...
	public RouteBuilder createRouteBuilder() {
		return new RouteBuilder() {
			...
			public void configure() throws Exception {
				...
				from("direct:start").bean(EmailProcessorBean.class)
